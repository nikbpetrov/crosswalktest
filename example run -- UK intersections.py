...
intersect, diagnostics_obj = cw.crosswalk(source_filepath, source_shape_id, target_filepath, target_shape_id, 
																					...
																					export = True, export_filename = 'Exports/20210607_Postal Sectors to MSOA_Intersection')


# cw.print_diagnostics(diagnostics_obj) -- optional; prints text diagnostics to console
cw.save_diagnostics_to_word(diagnostics_obj, output_type = 'text', filename = 'Exports/20210607_Post Sectors to MSOA_Diagnostics text')
cw.save_diagnostics_to_word(diagnostics_obj, output_type = 'table', filename = 'Exports/20210607_Post Sectors to MSOA_Diagnostics table')
